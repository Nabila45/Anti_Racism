...
st.sidebar.write("Unlock our proposed features [click here](https://antiracism.tiiny.site)")
# Initialize chat history
if "messages" not in st.session_state:
    st.session_state.messages = []

# Display Chat Messages
st.title("🚀 AI-Powered Inclusion & Anti-Racism Support System: Safe Chat")
